...
public final class FragmentContactBinding implements ViewBinding {
  ...
  private FragmentContactBinding(@NonNull ConstraintLayout rootView, @NonNull WebView webView) {
  ...
  public static FragmentContactBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentContactBinding((ConstraintLayout) rootView, webView);
    }
